...
const displayComputedProperties = () => {
  computedProperties.value = !computedProperties.value;
};

const displayClassAndStyleBindings = () => {
  classAndStyleBindin.value = !classAndStyleBindin.value;
};
